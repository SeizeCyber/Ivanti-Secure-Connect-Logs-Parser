...
if ($result -eq 'OK') {
    ...
    $messageCodeDescriptions = @{
        ...
        "SYS31408" = "Un-Official - Port and Protocol Syslog msg"
        "SYS31407" = "Un-Official - Port and Protocol Syslog msg"
        "SYS31409" = "Un-Official - Port and Protocol Syslog msg"
        "SYS31048" = "Un-Official - Port and Protocol Syslog msg"
        "SYS31415" = "Un-Official - Port and Protocol Syslog msg"
        "SYS31437" = "Successful syslog connection to peer"
        "SYS23041" = "Log Nearly Full"
        "DMI24606" = "Received Netconf RPC request"
        "SYS32140" = "Starting hourly nSA sessions sync"
        "SYS32142" = "RESTAPI POST failed with response code - 500"
        "ONE31441" = "Ivanti Neurons Notifcation Channel Status"
        "SYS31280" = "Generic Syslog For Ivanti Neurons"
        "SYS31282" = "Generic Syslog For Ivanti Neurons"
        "ADM31986" = "Integrity checker Status"
        "SYS32100" = "Integrity Scan Results"
        "SYS31231" = "Post Settings Request"
        "EAS24458" = "Endpoint Assurance InitializeEngine."
        "SYS32020" = "Un-Official - Put API Request for self readiness"
        "SYS31982" = "Un-Official - Health Issues"
        "SYS31983" = "Un-Official - API Request for self capabilities"
        "ERR20645" = "Watchdog  process has exceeded number of file descriptors"
        "UNI31440" = "Ivanti Neurons Notifcation Channel Refused"
        "SYS24348" = "Un-Official - Diagnostic"
        "SYS10062" = "Un-Official - Clustering is off"
